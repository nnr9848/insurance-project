          ...
          <div style={{
            ...
            {mobileAccordion === 'products' && (
              <div style={{ 
                ...
                {[
                  { title: 'Health Insurance', icon: <HeartPulse size={16} color="#0f2b48" />, link: '/new-policy-support' },
                  { title: 'Term Life Insurance', icon: <ShieldCheck size={16} color="#0f2b48" />, link: '/new-policy-support' },
                  { title: 'Car & 2-Wheeler Insurance', icon: <Car size={16} color="#0f2b48" />, link: '/new-policy-support' },
                  { title: 'Family Health Floater', icon: <Users size={16} color="#0f2b48" />, link: '/new-policy-support' },
                  { title: 'Corporate / SME Insurance', icon: <Briefcase size={16} color="#0f2b48" />, link: '/new-policy-support' },
                  { title: 'Travel Insurance', icon: <Plane size={16} color="#0f2b48" />, link: '/new-policy-support' }
                ].map((item, idx) => (
                  <Link
                    key={idx}
                    to={item.link}
