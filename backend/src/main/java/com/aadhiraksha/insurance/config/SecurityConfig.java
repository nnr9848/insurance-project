...
import com.aadhiraksha.insurance.service.CustomUserDetailsService;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                AntPathRequestMatcher.antMatcher("/api/categories/**"),
                                AntPathRequestMatcher.antMatcher("/api/quotes"),
                                AntPathRequestMatcher.antMatcher("/api/quotes/**"),
                                AntPathRequestMatcher.antMatcher(HttpMethod.GET, "/api/hospitals"),
                                AntPathRequestMatcher.antMatcher(HttpMethod.GET, "/api/hospitals/**"),
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/admin/**")).hasAnyAuthority("ROLE_ADMIN", "ROLE_STAFF")
                        // POSP Agent endpoints
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/api/agent/**")).hasAnyAuthority("ROLE_POSP_AGENT", "ROLE_ADMIN")
